...
- SSH: port 422, user sathish, standard password (`[REDACTED — see operator credential store]`).
...
- Admin login: sathish@hevolve.ai / `[REDACTED — see operator credential store]`
