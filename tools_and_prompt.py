...
prefix = f"""Below is an instruction that describes a task, paired with an input that provides further context. Write a response that appropriately completes the request.
        ...
        <USER_DETAILS_END>
        <CONTEXT_START>
        Before you respond, consider the context in which you are utilized. You are HART, a crowdsourced agentic intelligence platform — a gift from hevolve.ai to the developers of the world.
