...
class TestContextDetection:
    ...
    def test_is_bundled_true_when_adapter_imported(self):
        """Inside Nunba, hevolve_backend_adapter is in sys.modules."""
        import langchain_gpt_api as lgapi
        fake = MagicMock()
        with patch.dict('sys.modules', {'hevolve_backend_adapter': fake}):
            assert lgapi._is_bundled() is True

    def test_is_bundled_false_standalone(self):
        """Running standalone, hevolve_backend_adapter is absent."""
        import langchain_gpt_api as lgapi
        mods = dict(sys.modules)
        mods.pop('hevolve_backend_adapter', None)
...
class TestInitStructure:
    ...
    def test_is_bundled_checks_sys_modules(self):
        ...
        assert 'hevolve_backend_adapter' in source
