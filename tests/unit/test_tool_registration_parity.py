...
def test_persona_caches_assigned_only_in_core_persona_registry():
    ...
    files_to_check = (os.path.join('hartos', 'hartos/reuse_recipe.py'), os.path.join('hartos', 'hartos/create_recipe.py'))
...
def test_send_message_to_roles_registered_in_both_flows():
    ...
    reuse_src = _read(os.path.join(REPO_ROOT, 'hartos', 'hartos/reuse_recipe.py'))
    create_src = _read(os.path.join(REPO_ROOT, 'hartos', 'hartos/create_recipe.py'))
...
def test_tier2_goal_detection_parity():
    ...
    for filename in (os.path.join('hartos', 'hartos/create_recipe.py'), os.path.join('hartos', 'hartos/reuse_recipe.py')):
