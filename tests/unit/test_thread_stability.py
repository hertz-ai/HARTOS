...
class TestPackagingModules:
    ...
    def test_agent_identity_importable(self):
        from hartos import agent_identity
    ...
    def test_agent_identity_functions(self):
        from hartos.agent_identity import build_identity_prompt, SECRETS_GUARDRAIL
    ...
    def test_all_py_modules_importable(self):
        ...
        modules = [
            'hartos.helper', 'hartos.helper_ledger', 'hartos.threadlocal',
            'hartos.create_recipe', 'hartos.reuse_recipe', 'hartos.gather_agentdetails',
            'hartos.lifecycle_hooks', 'hartos.cultural_wisdom', 'hartos.exception_collector',
            'hartos.agent_identity', 'hartos.hart_onboarding', 'hartos.hart_cli',
        ]
