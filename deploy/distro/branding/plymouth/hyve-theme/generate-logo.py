#!/usr/bin/env python3
"""Generate hyve-logo.png for Plymouth boot splash.

Run during ISO build (in chroot hook) or manually:
    python3 generate-logo.py

Outputs: hyve-logo.png (200x200, dark background with teal H hexagon)
...
try:
    ...
    out_path = os.path.join(os.path.dirname(__file__), 'hyve-logo.png')
...
OUTPUT = os.path.join(SCRIPT_DIR, 'hyve-logo.png')
