    ...
    def _load_secret_key() -> str:
        ...
        if not key:
            try:
                ...
                pass
        if not key:
            # Read the persistent key file that integrations.social.auth writes.
            # Both ends share ONE candidate list (core.platform_paths) so a token
            # minted by either is verifiable by the other (#98e).
            try:
