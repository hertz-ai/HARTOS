...
sudo docker run -dp 5000:5000 --network host -v "/opt/hzai-langchain/logs/langchain.log:/app/langchain.log" -v "/opt/hzai-langchain/mount/images:/app/output_images/" --name langchain langchain_gpt1:v1