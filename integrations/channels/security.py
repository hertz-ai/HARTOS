...
class PairingManager:
    ...
    def generate_pairing_code(
        ...
        # Persist so a pairing code generated by one request handler
        # (each API request builds its own PairingManager instance)
        # is visible to the later request that verifies it.
        self._save_state()
