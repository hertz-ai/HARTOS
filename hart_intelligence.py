...
This is the canonical name. The legacy name 'hart_intelligence_entry' is preserved
...
Usage:
    ...
    from hart_intelligence_entry import get_ans, app, get_llm, publish_async
"""

# Re-export everything from the implementation module.
# The actual code stays in hart_intelligence_entry.py for now — renaming a 5000+ line
